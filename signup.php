      ...
      <div class="container">
        <div class="row">
          <div class="span6 offset3">
            <h4 class="widget-header"><i class="icon-gift"></i> Welcome to Rajasthan Tourism</h4>
            <div class="widget-body">
              <div class="center-align">
                <form class="form-horizontal form-signin-signup" method="post" action="reg.php" onsubmit="return validation()" onsubmit="validation()">
                ...
                <a href="index.php" class="btn btn-large bottom-space">Signin</a>
